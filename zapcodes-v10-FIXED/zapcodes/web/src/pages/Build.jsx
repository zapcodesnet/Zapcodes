...
export default function Build() {
  ...
  const maxChars = tc.maxChars || 1500;
        ...
        <div style={s.leftPanel}>
              ...
              <div style={s.chatArea} className="chat-messages">
                ...
                {files.length > 0 && (
                  <div style={s.fileList}>
                    <div style={{ fontSize: 13, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 8 }}>Generated Files ({files.length})</div>
                    {files.map((f, i) => (
          ...
          {tab === 'fix' && (
            <div style={s.chatArea}>
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: 13, marginBottom: 16 }}>Upload files and describe the issue.</p>
