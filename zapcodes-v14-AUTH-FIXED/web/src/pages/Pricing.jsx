...
const TIERS = [
  {
    ...
    rows: [
      ...
      { label: 'Total Generations', value: '10/mo (shared)', highlight: true },
      { label: '• Gemini 2.5 Flash', value: '3 gen (trial)', dim: true },
      { label: '• Groq AI', value: '10 gen/mo' },
  ...
  },
  {
    ...
    rows: [
      { label: 'AI Models', value: '', header: true },
      { label: 'Total Generations', value: '400/mo (shared)', highlight: true },
      { label: '• Gemini 3.1 Pro', value: '3 gen (trial)', dim: true },
      { label: '• Gemini 2.5 Flash', value: '120 gen/mo' },
      { label: '• Groq AI', value: '400 gen/mo' },
      { label: 'Char Limit', value: '3,000 chars' },
      { label: 'Features', value: '', header: true },
      { label: 'Deployed Sites', value: '3 sites' },
      { label: 'Code Fixes', value: '50/mo' },
      { label: 'GitHub Push', value: '50/mo' },
      { label: 'File Uploads', value: '200KB' },
      { label: 'Pro Developer', value: '—', dim: true },
      { label: 'Badge Remove', value: '—', dim: true },
      { label: 'Daily BL Claim', value: '20K BL/day', highlight: true },
      { label: 'BlendLink', value: '', header: true },
      { label: 'Photo Minting', value: '15/day' },
  ...
  },
  {
    ...
    rows: [
      { label: 'AI Models', value: '', header: true },
      { label: 'Total Generations', value: '1,000/mo (shared)', highlight: true },
      { label: '• Gemini 3.1 Pro', value: '60 gen/mo', highlight: true },
      { label: '• Gemini 2.5 Flash', value: '400 gen/mo' },
      { label: '• Haiku 4.5', value: '200 gen/mo', highlight: true },
      { label: '• Groq AI', value: '1,000 gen/mo' },
      { label: 'Char Limit', value: '4,000 chars' },
      { label: 'Features', value: '', header: true },
      { label: 'Deployed Sites', value: '5 sites' },
      { label: 'Code Fixes', value: '200/mo' },
      { label: 'GitHub Push', value: '200/mo' },
      ...
      { label: 'BlendLink', value: '', header: true },
      { label: 'Photo Minting', value: '35/day' },
  ...
  },
  {
    ...
    rows: [
      { label: 'AI Models', value: '', header: true },
      { label: 'Total Generations', value: '2,000/mo (shared)', highlight: true },
      { label: '• Gemini 3.1 Pro', value: '200 gen/mo', highlight: true },
      { label: '• Sonnet 4.6 🧠', value: '100 gen/mo', highlight: true },
      { label: '• Gemini 2.5 Flash', value: '1,000 gen/mo' },
      { label: '• Haiku 4.5', value: '600 gen/mo', highlight: true },
      { label: '• Groq AI', value: '2,000 gen/mo' },
      { label: 'Char Limit', value: '5,000 chars' },
      { label: 'Features', value: '', header: true },
      { label: 'Deployed Sites', value: '15 sites' },
      { label: 'Code Fixes', value: '1,000/mo', highlight: true },
      { label: 'GitHub Push', value: '1,000/mo', highlight: true },
      ...
      { label: 'BlendLink', value: '', header: true },
      { label: 'Photo Minting', value: '100/day' },
    ...
    <div style={st.page}>
      ...
      <div style={{ maxWidth: 600, margin: '0 auto', padding: '20px 0' }}>
        <p style={{ color: 'var(--text-muted)', fontSize: 13, textAlign: 'center' }}>
          ...
          <br /><strong>Shared deduction:</strong> Each AI generation deducts 1 from your total monthly limit AND the model's individual limit.
        </p>
      </div>
    </div>
  );
