  ...
  try {
    ...
    const response = await axios.post(GROQ_API_URL, {
      ...
      messages: [
        {
          role: 'system',
          content: `You are ZapCodes, an expert code analyzer. Analyze the given code files and identify bugs, crashes, memory leaks, ANRs, security issues, and performance problems. Return ONLY valid JSON array of issues with this structure:
[{
