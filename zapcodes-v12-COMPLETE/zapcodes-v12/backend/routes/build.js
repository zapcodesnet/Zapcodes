...
2. The index.html file MUST be a fully self-contained HTML document with ALL CSS in a <style> tag inside <head> and ALL JavaScript in a <script> tag before </body>.
...
12. Use a cohesive color palette with CSS custom properties.
13. Typography: Use system font stack or Google Fonts via CDN.
...
IMPORTANT: The PRIMARY output must be a SINGLE index.html file with everything inlined (CSS in <style>, JS in <script>).`;
...
7. Ensure all interactive elements work.
