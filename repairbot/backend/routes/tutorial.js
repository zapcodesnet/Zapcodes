...
router.get('/topics', (req, res) => {
  res.json({
    topics: [
      { id: 'getting-started', title: 'Getting Started with RepairBot', question: 'How do I get started with RepairBot?' },
      { id: 'scan-repo', title: 'How to Scan a Repository', question: 'How to scan a GitHub repo?' },
      { id: 'moltbot', title: 'What is Moltbot?', question: 'What does Moltbot do and how does it work?' },
      { id: 'apply-fix', title: 'Applying Fixes', question: 'How to apply a fix to my code?' },
      { id: 'engines', title: 'AI Engines Explained', question: 'What is the difference between Ollama and Claude Pro?' },
      { id: 'platforms', title: 'Supported Platforms', question: 'What platforms does RepairBot support?' },
