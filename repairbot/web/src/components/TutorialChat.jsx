...
export default function TutorialChat() {
  ...
  const [messages, setMessages] = useState([
    { role: 'bot', content: "👋 Hi! I'm the RepairBot assistant. Ask me anything about how to use RepairBot — scanning repos, applying fixes, pricing, and more!" },
  ]);
      ...
      {open && (
        <div style={styles.panel}>
          ...
          <div style={styles.header}>
            <div>
              <div style={{ fontWeight: 700, fontSize: '1rem' }}>🤖 RepairBot Help</div>
