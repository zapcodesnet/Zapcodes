...
const steps = [
  { num: '01', title: 'Paste GitHub URL', desc: 'Drop your repo link — public or private. RepairBot clones and indexes every file.', icon: '🔗' },
      ...
      <nav style={styles.nav}>
        <div className="container flex items-center justify-between" style={{ height: 72 }}>
          <div className="flex items-center gap-2">
            ...
            <span style={styles.logoText}>RepairBot</span>
          </div>
          <div className="flex items-center gap-2">
            {user ? (
        ...
        <div className="container text-center">
          ...
          <div className="animate-in stagger-5" style={styles.terminal}>
            <div style={styles.terminalBar}>
              ...
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.75rem', color: 'var(--text-muted)' }}>repairbot scan</span>
            </div>
            <pre style={styles.terminalCode}>
{`$ repairbot scan https://github.com/user/my-app
  ...
  → `}<span style={{ color: 'var(--accent)' }}>[Apply Fix via Moltbot]</span>{` → PR #47 created ✓`}
      ...
      <footer style={styles.footer}>
        <div className="container flex items-center justify-between" style={{ flexWrap: 'wrap', gap: 16 }}>
          <div className="flex items-center gap-2">
            <span style={styles.logoIcon}>⚡</span>
            <span style={{ fontWeight: 700, fontSize: '0.9rem' }}>RepairBot</span>
          </div>
          <span style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>
            © 2026 RepairBot. AI-powered code repair.
          </span>
        </div>
      </footer>
    </div>
