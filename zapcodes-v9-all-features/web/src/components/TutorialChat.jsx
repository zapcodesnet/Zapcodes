  ...
  const send = async () => {
    ...
    try {
      ...
      if (zapcodesSolution && escalationCount < 2) {
        ...
        const { data } = await api.post('/files/analyze', {
...
- Dashboard (/dashboard): Scan repos for bugs, "Scan a File" for uploaded code analysis, auto-fix via Moltbot
- Settings (/settings): GitHub token management for Moltbot auto-push
- Moltbot: AI bot that can auto-push code fixes to GitHub repos
