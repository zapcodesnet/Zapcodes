...
export default function TutorialScreen() {
  const [messages, setMessages] = useState([
    { role: 'assistant', content: 'Hey! I\'m ZapCodes Assistant. Ask me anything about scanning repos, fixing bugs, or how ZapCodes AI works.' }
  ]);
    ...
    >
      ...
      >
        ...
        {messages.map((msg, i) => (
          ...
          >
            {msg.role === 'assistant' && (
              <Text style={styles.botLabel}>ZapCodes</Text>
            )}
            <Text style={[
              styles.bubbleText,
      ...
      <View style={styles.inputRow}>
        <TextInput
          style={styles.input}
          placeholder="Ask about ZapCodes..."
