      ...
      <section style={styles.content}>
        <div className="container" style={{ maxWidth: 800 }}>
          ...
          <div style={styles.body}>
            ...
            <p>
              <strong style={styles.strong}>4.5 Trademarks.</strong> "ZapCodes," the ZapCodes logo, "ZapCodes AI," and all related names, logos, product and service names, designs, and slogans are trademarks of ZapCodes. You may not use these marks without the prior written permission of ZapCodes. All other trademarks not owned by ZapCodes that appear on the Service are the property of their respective owners.
            </p>
            <p>
